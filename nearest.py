...
def nearest(
    ...
    padded_data = np.pad(input_data, pad_width=1, mode="constant", constant_values=np.nan)
    index = tuple(
    ...
    # return padded_data[tuple(np.meshgrid(*index))].T
...
z = nearest(input_grids, input_data, output_grids)
print("*** z:", z)
